...
### Corrigé / amélioré
- **Formulaire harmonisé** : les rubans Marque/Modèle/Devise avaient une hauteur
  excessive (texte tronqué, chevrons mal placés). Tous les champs partagent
  désormais la même hauteur, un rayon et des couleurs cohérents ; le champ de
  saisie interne des listes éditables est détouré ; flèche du champ date nettoyée.
