...
CREATE TABLE IF NOT EXISTS simulations (
    ...
    taux_fret         REAL    NOT NULL DEFAULT 0,  -- 0 = identique au taux d'achat
...
MIGRATIONS = [
    ...
    ("simulations", "taux_fret",
     "ALTER TABLE simulations ADD COLUMN taux_fret REAL NOT NULL DEFAULT 0"),
]
