...
_FIELDS = [
    ...
    ("taux_fret_usd", "Taux fret USD/DZD", "DA pour 1 USD", "ex : 250", RATE_PATTERN),
    ("taux_fret_eur", "Taux fret EUR/DZD", "DA pour 1 EUR", "ex : 270", RATE_PATTERN),
    ("taux_fret_cny", "Taux fret CNY/DZD", "DA pour 1 CNY", "ex : 35", RATE_PATTERN),
    ...
    def save_clicked(self) -> None:
        try:
            validated = validate_settings_input(
                ...
                taux_fret_usd=self.fields["taux_fret_usd"].text(),
                taux_fret_eur=self.fields["taux_fret_eur"].text(),
                taux_fret_cny=self.fields["taux_fret_cny"].text(),
            )
